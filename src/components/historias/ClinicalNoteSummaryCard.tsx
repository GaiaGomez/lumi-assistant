    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 line-clamp-1 text-[14px] font-medium" style={{ color: 'var(--ink-cool-strong)' }}>
      ...
      <p className="mt-2 line-clamp-2 text-[12px] leading-5" style={{ color: 'var(--ink-cool-soft)' }}>
        {getClinicalNoteSummary(note)}
      </p>
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {note.appointment_id && (
            <span className="rounded-full px-2.5 py-1 text-[11px]" style={{ background: 'rgba(255,255,255,0.46)', color: 'var(--ink-cool-soft)' }}>
              Vinculada a sesion
            </span>
          )}
        </div>
